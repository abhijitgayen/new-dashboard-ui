  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex w-full">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="h-16 glass-effect border-b border-border/50 flex items-center justify-between px-6 relative">
          ...
          <div className="flex items-center gap-2 relative z-10">
            <Button variant="ghost" size="icon" className="relative hover-accent">
        ...
        <main className={`flex-1 p-6 overflow-y-auto bg-gradient-to-br from-background via-background to-accent-color/5 ${
